...
const resources = {
  en: {
    translation: {
      ...
      "me": "me",
      "About me": "My name is Henrique Lourenço. I am a web developer based in Santos, Brazil. I'm very passionate and dedicated to my work. I like the lifelong learning style, I always want to improve and acquire knowledge.With 2 years experiences as web developer, I have acquired the skills necessary to build great and premium websites.",
  ...
  es: {
    translation: {
        ...
        "me": "yo",
        "About me": "Mi nombre es Henrique Lourenço. Soy un desarrollador web con sede en Santos, Brasil. Soy apasionado y dedicado a mi trabajo. Me gusta el estilo de aprendizaje constante, siempre busco mejorar y adquirir conocimientos. Con 2 años de experiencia como desarrollador web, he adquirido las habilidades necesarias para construir sitios web excelentes y de alta calidad.",
  ...
  pt: {
    translation: {
        ...
        "Contact": "Contato",
        "Hello": "Hello",
        "I'm Henrique Lourenço": "Eu sou Henrique Lourenço",
        "Web Developer": "Desenvolvedor Web",
        "me": "mim",
        "About me": "Meu nome é Henrique Lourenço. Sou um desenvolvedor web baseado em Santos, Brasil. Sou muito apaixonado e dedicado ao meu trabalho. Gosto do estilo de aprendizado contínuo, sempre busco melhorar e adquirir conhecimento. Com 2 anos de experiência como desenvolvedor web, adquiri as habilidades necessárias para construir sites excelentes e de alta qualidade.",
